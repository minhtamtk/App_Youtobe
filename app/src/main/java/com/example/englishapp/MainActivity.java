...
import com.example.englishapp.fragment.ExploreFragment;
import com.example.englishapp.fragment.HomeFragment;
import com.example.englishapp.fragment.LibraryFragment;
import com.example.englishapp.fragment.SubsciptionsFragment;
...
public class MainActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.subscriptions:
                        SubsciptionsFragment subsciptionsFragment = new SubsciptionsFragment();
                        selectedFragment(subsciptionsFragment);
                        break;
    ...
    private void showPublishContentDialogue() {
        ...
        dialog.setContentView(R.layout.upload_dialoglue);
        ...
        TextView txt_poll = dialog.findViewById(R.id.txt_relase_poll);
            ...
            case RC_SIGN_IN:
                if (resultCode == RESULT_OK && data != null){
                    ...
                    try {
                        ...
                        auth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<com.google.firebase.auth.AuthResult>() {
    ...
    // to fetch the profile picture from firebase database
    private void getProfileImage() {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            Toast.makeText(this, "Login PLz", Toast.LENGTH_SHORT).show();
        }
    }
