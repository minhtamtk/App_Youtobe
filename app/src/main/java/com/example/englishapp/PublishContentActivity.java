...
import com.example.englishapp.Adapter.PlaylistAdapter;
import com.example.englishapp.Model.PlaylistModel;
...
public class PublishContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_chosse_playlist = findViewById(R.id.choose_playlist);
    ...
    //    txt_upload.setOnClickListener(new View.OnClickListener() {
     //       @Override
      //      public void onClick(View v) {
       //         Toast.makeText(PublishContentActivity.this, "Yess", Toast.LENGTH_SHORT).show();
        //    }
        // });

        txt_chosse_playlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        txt_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (txt_chosse_playlist.getText().toString().equals("Choose Playlist")) {
                    Toast.makeText(PublishContentActivity.this, "Please select playlist", Toast.LENGTH_SHORT).show();
                } else {
                    //now create a medthod to uploadvideos
    ...
    private void uploadVideoToStorage(String title, String description) {
        ...
        sRef.putFile(videoUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
    ...
    private void showPlaylistDialogue() {
        ...
        adapter = new PlaylistAdapter(PublishContentActivity.this, list, new PlaylistAdapter.OnitemClickListener() {
            ...
            public void onitemClick(PlaylistModel model) {
                ...
                txt_chosse_playlist.setText("Playlist : " +model.getPlaylist_name());
            }
        });
