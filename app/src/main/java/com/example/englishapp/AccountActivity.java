    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_your_channel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // in this line we gone check if user have channel already or not so it will help to creat a channel
        ...
        reference.child("Channels").child(user.getUid()).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    dialog.dismiss();
                    Toast.makeText(AccountActivity.this, name+"channel has been create", Toast.LENGTH_SHORT).show();
                }else {
                    progressDialog.dismiss();
                    dialog.dismiss();
